...
def display():
    ...
    try:
        with open(r'C:\Users\chetankoliparthi\OneDrive\Documents\projects\disease\predictors\kidney_scaler.pkl', 'rb') as scaler_file:
            scaler = pickle.load(scaler_file)

        with open(r'C:\Users\chetankoliparthi\OneDrive\Documents\projects\disease\predictors\kidney_knn.pkl', 'rb') as model_file:
